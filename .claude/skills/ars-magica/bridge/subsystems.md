...
| Warping & Twilight | every scene | If a magus stood in aura 6+, cast a 6th-magnitude+/constant effect, or BOTCHED a supernatural roll, accrue Warping Points (1 per `0` on the botch dice); at a new threshold roll for Wizard's Twilight. |
...
| Aging | on trigger: each in-game year (Winter) for any character aged 35+ | Roll an Aging Total per such character (`arm.py roll stress` no-botch + age/10 − living conditions − longevity ritual); apply Aging Points / Decrepitude / Crisis. |
